...
import { Calendar, Users, CheckSquare, Pencil, Archive } from 'lucide-react';
...
export default function ProjectCard({ project, onClick, onEdit, onArchive }: ProjectCardProps) {
  return (
    <div
    ...
    >
      ...
      <div className="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <button
          ...
          className="p-2 bg-white dark:bg-gray-700 rounded-lg hover:bg-amber-100 dark:hover:bg-amber-900/30"
        >
