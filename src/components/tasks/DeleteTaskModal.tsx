...
export default function DeleteTaskModal({ taskId, taskTitle, onClose, onDeleted }: DeleteTaskModalProps) {
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-md rounded-lg bg-white dark:bg-gray-800 shadow-xl">
          <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 p-4">
            <h2 className="text-xl font-semibold text-red-600 dark:text-red-500">Delete Task</h2>
            <button
              onClick={onClose}
