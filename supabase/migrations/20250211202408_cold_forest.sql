/*
  # Fix User Relationships and Foreign Keys

  1. Changes
    - Add proper foreign key references to auth.users
    - Update view permissions for auth.users
    - Fix project members and comments relationships
...
-- Create a view to safely expose user information
